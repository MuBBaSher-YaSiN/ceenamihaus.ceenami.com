...
/>
                        ...
                        <div>
                          <h4 className="text-lg md:text-xl font-semibold text-white">{review.name}</h4>
                      ...
                      <p className="text-gray-300 text-sm md:text-base lg:text-lg leading-relaxed mb-4 md:mb-6">{review.text}</p>
                      <div className="absolute bottom-4 md:bottom-6 right-4 md:right-6">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-blue-500/20">
                          <path d="M7 17h10v3H7v-3zm5-12L7 6v2h10V6l-5-1z" fill="currentColor" />
                        </svg>
                      </div>
                    </div>
                  </motion.div>
